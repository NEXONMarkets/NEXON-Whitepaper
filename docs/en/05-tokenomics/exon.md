---
description: "EXON is the Circulation Engine of the NEXON narrative and today the Core Value Token: the private sale is the only route, it is sell-only, and it burns on withdrawal."
icon: circle-e
---
...
In the NEXON narrative, EXON is the **Circulation Engine**, connecting digital finance to the exchange, experiences, payment, fees and consumption. In the current mechanism, EXON is the **Core Value Token**: subscribed in the private sale, listed on spot, released daily, bought into the fuel wallet, burned on withdrawal.
