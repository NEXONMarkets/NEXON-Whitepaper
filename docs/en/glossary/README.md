---
description: "Bilingual glossary for NEXON's narrative, current mechanism, long-term products and disclosure boundaries."
icon: book
---
...
| Term | 中文 | Definition |
|---|---|---|
| Intent | 意图 | A structured user goal, its constraints and approval mode; not a transaction, not an authorisation |
| Route | 路径 | A versioned sequence of eligible legs with cost, executor, permissions and failure behaviour |
| Policy Check | 策略校验 | A deterministic decision on account, jurisdiction, balance, limits and product rules |
...
| Term | 中文 | Definition |
|---|---|---|
| AI-Native PayFi | AI 原生 PayFi | The live Value Router; EXON is its circulation and settlement token; AI is not a yield engine |
| Wallet | 钱包 | The financial home for state, permissions, the staking entry and eligible third-party experiences (in development) |
| Prediction market | 预测市场 | A third-party entry point governed by its own custody, settlement and jurisdiction rules |
| Marketplace | 商城 | The real-consumption surface for travel, hotels, goods and services, executed under supplier terms (in development) |
| Stablecoin Card | 稳定币卡 / U 卡 | An everyday acceptance product that requires a licensed issuer / operator (Roadmap) |
| Decentralized Social App | 去中心化社交 App | The discovery and community surface; social context never authorises financial execution (in development) |
| Open | 待定 | An implementation field awaiting the project's written decision |

## Usage discipline

"Per-settlement yield," "term bonus," "ROI" and "subscription recovered" describe **mechanism parameters or arithmetic**. "Value Anchor" describes an ecosystem role. "Circulation Engine" describes the direction in which EXON connects to the five entry points one by one.
