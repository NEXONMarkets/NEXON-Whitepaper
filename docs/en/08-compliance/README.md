---
description: "Operational separation, disclosure discipline, responsible-party mapping, and the jurisdiction gates for current and long-term products."
icon: building-shield
---

# Compliance & Legal Posture

NEXON is an independent, community-initiated project built within the NEX ecosystem; it is not an official NEX product. XO and EXON are NEXON project assets, not NEX platform tokens. **A similar name, an integration or an account connection cannot be used to imply authorship, approval, liability or principal protection that no document supports.**
...
*Previous: [Security & Risk](../07-security-and-risk/README.md) · Next: [Roadmap](../09-roadmap/README.md)*
