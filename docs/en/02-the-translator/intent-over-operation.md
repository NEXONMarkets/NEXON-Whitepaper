...
Where the Staking Platform is involved, the check follows the real mechanism: 28% buys EXON at 1 USDT each as fuel, and the rest is swapped into XO and staked. The interface cannot present the fuel purchase as a fee, nor the fuel as a transferable balance.
{% endtab %}
