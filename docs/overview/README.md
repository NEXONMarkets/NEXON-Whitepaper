...
| 当前机制 | 质押本金代币，每 12 小时结算 0.3% – 1.0%，三种奖励一律以 XO 发放 | 核心价值代币，私募唯一渠道，只能卖不能买，提取即销毁 |
| 定价 | NEX 二级市场自由交易 | 私募 0.1 U，上线 1.0 U |
| 流通 | NEX 自由买卖 | 上线起在 NEX 现货流通，只挂卖单、不挂买单 |
| 供给 | 总量 10 亿枚 | 总量 10 亿枚，私募 2 亿枚，1,095 天逐日释放 |

EXON 在当前机制里承担三件已经确认的事，交易、支付、兑换与手续费随五个入口逐个接入：
...
| :-- | :-- |
| ① 入金 | 30,000 U |
| ② 拆分 | 8,400 U 按 1 U 等值买入 8,400 枚 EXON 存入燃料钱包；其余兑换 XO 进入质押 |
| ③ 结算 | 每 12 小时一次，单次 0.3% – 1.0%，一天 180 – 600 U，收益以 XO 到账 |
| ④ 加成 | 选 540 天档 +50%，一天 270 – 900 U |
| ⑤ 提取 | 立即到账烧 30%、30 天到账烧 20%、60 天到账烧 10%，从燃料钱包销毁 EXON |

同样 30,000 U，选不同期限，每天到账与期限合计差得很远：

| 期限 | 加成 | 每天 | 每月 | 期限合计 |
| :-- | --: | --: | --: | --: |
| 30 天 | 基础 | 180 – 600 U | 5,400 – 18,000 U | 5,400 – 18,000 U |
| 90 天 | +10% | 198 – 660 U | 5,940 – 19,800 U | 17,820 – 59,400 U |
| 180 天 | +20% | 216 – 720 U | 6,480 – 21,600 U | 38,880 – 129,600 U |
| 360 天 | +30% | 234 – 780 U | 7,020 – 23,400 U | 84,240 – 280,800 U |
| 540 天 | +50% | 270 – 900 U | 8,100 – 27,000 U | 145,800 – 486,000 U |

**注意每天那一列**：从 180 到 270，差的是 1.5 倍的加成；期限合计拉开的，是时间——时间站在质押者这一边。

### 时间是收益的变量 <a href="#s6-2" id="s6-2"></a>

质押进入选定的期限，期限越长加成越高，只看期限不看金额。单次 0.3% – 1.0% 乘以加成，每 12 小时结算一次：

![](.gitbook/assets/onepage-05-term-ladder.svg)

| 期限 | 加成 | 质押 1,000 U · 每天 | 期满 | 累计锁定 |
| :-- | --: | --: | :-- | --: |
| 30 天 | 基础 | 6 – 20 U | 第 31 天退出窗口 | 1,200 天 |
...
| 到账方式 | 燃料钱包销毁 | 提取 1,000 U 销毁（按 1.0 U 计） |
| :-- | --: | --: |
| 立即到账 | 30% | 300 枚 |
| 30 天线性到账 | 20% | 200 枚 |
| 60 天线性到账 | 10% | 100 枚 |
...
|  | 内容 |
| :-- | :-- |
| **已确认** | 双层架构与统一账户 · 28% 燃料钱包 · 每 12 小时 0.3% – 1.0% 结算与期限加成 · 第 31 天退出窗口 · 私募 0.1 U 上线 1.0 U · 1,095 天线性释放 · 三档到账与燃料销毁 · 20 代推广奖励与 V1 – V12 领导奖金 |
| **产品** | AI 原生 PayFi 已上线；钱包、商城、去中心化社交开发中；U 卡规划中。XO 的治理与更广泛权益、EXON 的支付 / 兑换 / 手续费 / 消费用途随入口开放 |
