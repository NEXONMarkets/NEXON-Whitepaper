...
券商账户里的一笔仓位、钱包里的一枚代币、东京十月的四个晚上，都是价值。但它们从来没有在同一本账上出现过。今天，把第一样东西变成第三样，仍然要经过四个系统、四次身份验证和一个星期——每一步都有一个人在手动把一种价值语言翻译成另一种。
...
NEXON 是基于 NEX 生态、由社区发起的独立项目，不是 NEX 官方产品；EXON 也不是 NEX 平台币。
