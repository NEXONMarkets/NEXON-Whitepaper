---
description: "私募 0.1 U、上线 1.0 U；质押每 12 小时结算 0.1% – 1.0%；EXON 只能卖不能买，提取即销毁。一页读完 NEXON 的全部机制与数字。"
icon: bolt
...
- **28% 买入 EXON。** 按当时 1 U 等值买入 2,800 枚，存入燃料钱包。燃料钱包只进不出：不能转出、不能交易，只能在提取收益时销毁。
- **其余兑换 XO，进入质押。** 每 12 小时结算一次，一天 20 – 200 U，收益以 XO 到账，随时可提取。
...
单次 0.1% – 1.0%，北京时间 08:00 / 20:00 各结算一次，一天两次。**质押 10,000 U，一天 20 – 200 U。**

期限越长，加成越高，只看期限、不看金额。540 天档一律 +50%，质押 10,000 U 一天 30 – 300 U：

![](../.gitbook/assets/onepage-05-term-ladder.svg)

| 期限 | 加成 | 质押 10,000 U · 每天 | 质押 10,000 U · 每月 | 累计锁定 |
| :-- | --: | --: | --: | --: |
| 30 天 | 基础 | 20 – 200 U | 600 – 6,000 U | 1,200 天 |
| 90 天 | +10% | 22 – 220 U | 660 – 6,600 U | 1,170 天 |
| 180 天 | +20% | 24 – 240 U | 720 – 7,200 U | 1,080 天 |
| 360 天 | +30% | 26 – 260 U | 780 – 7,800 U | 900 天 |
| 540 天 | +50% | 30 – 300 U | 900 – 9,000 U | 540 天 |
...
### 收益满 100 U，再开一单 <a href="#s4-2" id="s4-2"></a>

收益累计满 100 U，就用这笔收益开一张新订单；新订单沿用原订单的期限加成，同样每 12 小时结算，收益再满 100 U 再开一单，一直算到原订单期满。期满总额 = 本金 + 原订单收益 + 所有新订单收益。按单次 0.1% 计：
...
期限越长，滚得越多：540 天档期满 **50,298 U，是本金的 5.0 倍**；只算原订单是 2.6 倍。
...
| :-- | --: | --: | --: |
| 1,000 万 U | 2 万 – 20 万 U | 0.6 万 – 6 万枚 | 219 万 – 2,190 万枚 |
| 5,000 万 U | 10 万 – 100 万 U | 3 万 – 30 万枚 | 1,095 万 – 1.09 亿枚 |
| 1 亿 U | 20 万 – 200 万 U | 6 万 – 60 万枚 | 2,190 万 – 2.19 亿枚 |
...
**演算：** 直推 5 人各质押 10,000 U，每人再直推 5 人，三代下来 5 / 25 / 125 人。第 1 代每天 15 – 150 U，第 2 代 50 – 500 U，第 3 代 250 – 2,500 U，**三代合计每天 315 – 3,150 U** —— 本人质押 100 U、直推满 4 人，1 – 4 代即已解锁。
...
| EXON 二级市场 | 只能卖，不能买 |
| 静态结算 | 每 12 小时 0.1% – 1.0%，北京时间 08:00 / 20:00 |
| 期限加成 | 基础 / +10% / +20% / +30% / +50% |
