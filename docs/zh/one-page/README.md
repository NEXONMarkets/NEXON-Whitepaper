...
{% hint style="success" %}
**EXON 第一轮早鸟私募。** 认购价 0.1 U，上线价 1.0 U，10 倍开盘；质押 XO 每 12 小时结算一次，一天两次；EXON 只能卖、不能买，提取一次烧一次。全文计价单位 **U**，锚定稳定币 USDT。
{% endhint %}
...
### 两个奖项 <a href="#s1-3" id="s1-3"></a>

澳门质量品牌国际认证联盟（MQBICL）向 NEXON 颁发「最具创新潜力奖」与「年度最佳设计奖」。
...
| 总量 | 铸币发行，不设固定总量 | 10 亿枚，私募只放 2 亿枚 |
...
质押总额到 1 亿 U，一年烧掉的接近两年的释放量；一天最多烧 36 万枚，是日释放的 2.0 倍。
...
**解锁举例：** 本人质押 500 U，有效直推 6 人，其中 4 人各质押 100 U 以上、2 人各质押 500 U 以上，可领取第 1 – 6 代；再增加 2 个质押 500 U 以上的直推，第 7、8 代随之打开。

**收益演算：** 直推 5 人，每人再直推 5 人，每人质押 10,000 U、每天静态产出 40 – 120 U：
...
本人质押 100 U、有效直推满 4 人，第 1 – 4 代即已解锁。奖励以 EXON 发放，表中的 U 是计值单位。
...
**举例：V8 晋升 V9。** 晋级即赠 30 点，贡献值余额上限 30 点；前 3 个月每天消耗 7.5 点（V9 标准的 50%），满 3 个月后恢复每天 15 点。

## 九、三个关键节点 <a href="#s9" id="s9"></a>

![](../.gitbook/assets/onepage-12-timeline.svg)

- **早鸟**　第一轮早鸟私募：按 0.1 U 认购，三档 1,000 / 5,000 / 10,000 U，同步配置 XO 质押。
- **质押**　大会，XO 质押启动：静态收益每 12 小时结算，推广奖励与领导奖金同步结算；静态收益提取时销毁燃料里的 EXON。
- **上线**　EXON 上线 1.0 U，首日释放：上线当日起连续 1,095 天逐日到账，可持有或在 NEX 卖出。
