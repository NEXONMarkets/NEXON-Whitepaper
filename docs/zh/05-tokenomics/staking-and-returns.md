---
description: "每 12 小时结算 0.1% – 1.0%、期限加成、第 31 天退出窗口、提取三档销毁，以及 20 代推广奖励与 V1 – V12 领导奖金。"
icon: chart-line
---

# 质押与收益

质押入金兑换为 XO 后即开始计息。**每 12 小时结算一次，单次 0.1% – 1.0%，北京时间 08:00 / 20:00，一天两次。** 收益以 XO 直接到账。

```text
单次结算  = 质押金额 × (0.1% – 1.0%) × (1 + 期限加成)
每天      = 单次结算 × 2
```

质押 10,000 U，一天 20 – 200 U；540 天档加成 +50%，一天 30 – 300 U。期满拿多少、收益满 100 U 再开单能滚到多少，见[完整演算案例](worked-examples.md)的案例 B：540 天档期满最高到本金的 17.2 倍。

## 五个期限 <a href="#five-terms" id="five-terms"></a>

<figure><img src="../.gitbook/assets/onepage-05-term-ladder.svg" alt="期限阶梯：30 天基础、90 天 +10%、180 天 +20%、360 天 +30%、540 天 +50%；质押 10,000 U 每天分别 20–200、22–220、24–240、26–260、30–300 U"><figcaption>期限越长，加成越高；加成只看期限，不看金额</figcaption></figure>

| 期限 | 加成 | 质押 10,000 U · 每天 | 质押 10,000 U · 每月 | 期满 | 累计锁定 |
|---:|---:|---:|---:|---|---:|
| 30 天 | 基础 | 20 – 200 U | 600 – 6,000 U | 第 31 天退出窗口 | 1,200 天 |
| 90 天 | +10% | 22 – 220 U | 660 – 6,600 U | 自动进入下一期限 | 1,170 天 |
| 180 天 | +20% | 24 – 240 U | 720 – 7,200 U | 自动进入下一期限 | 1,080 天 |
| 360 天 | +30% | 26 – 260 U | 780 – 7,800 U | 自动进入下一期限 | 900 天 |
| 540 天 | +50% | 30 – 300 U | 900 – 9,000 U | 期满取回本金 | 540 天 |
