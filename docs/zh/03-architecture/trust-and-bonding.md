...
<figure><img src="../.gitbook/assets/onepage-05-term-ladder.svg" alt="期限阶梯：30 天基础、90 天 +10%、180 天 +20%、360 天 +30%、540 天 +50%；质押 10,000 U 每天 40–120 U 到 60–180 U"><figcaption>期限越长，加成越高；加成只看期限，不看金额</figcaption></figure>

| 期限 | 加成 | 质押 10,000 U · 每天 | 期满 | 累计锁定 |
|---:|---:|---:|---|---:|
| 30 天 | 基础 | 40 – 120 U | 期满可取回，不收违约金 | 1,200 天 |
| 90 天 | +10% | 44 – 132 U | 自动进入下一期限 | 1,170 天 |
| 180 天 | +20% | 48 – 144 U | 自动进入下一期限 | 1,080 天 |
| 360 天 | +30% | 52 – 156 U | 自动进入下一期限 | 900 天 |
| 540 天 | +50% | 60 – 180 U | 期满取回本金 | 540 天 |
