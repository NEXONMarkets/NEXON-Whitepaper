...
**每 12 小时结算一次，单次 0.1% – 1.0%，北京时间 08:00 / 20:00**，乘以期限加成：

```text
单次结算 = 质押金额 × (0.1% – 1.0%) × (1 + 加成)
```

<figure><img src="../.gitbook/assets/onepage-05-term-ladder.svg" alt="期限阶梯：30 天基础、90 天 +10%、180 天 +20%、360 天 +30%、540 天 +50%；质押 10,000 U 每天 20–200 U 到 30–300 U"><figcaption>期限越长，加成越高；加成只看期限，不看金额</figcaption></figure>

| 期限 | 加成 | 质押 10,000 U · 每天 | 期满 | 累计锁定 |
|---:|---:|---:|---|---:|
| 30 天 | 基础 | 20 – 200 U | 第 31 天退出窗口，不收违约金 | 1,200 天 |
| 90 天 | +10% | 22 – 220 U | 自动进入下一期限 | 1,170 天 |
| 180 天 | +20% | 24 – 240 U | 自动进入下一期限 | 1,080 天 |
| 360 天 | +30% | 26 – 260 U | 自动进入下一期限 | 900 天 |
| 540 天 | +50% | 30 – 300 U | 期满取回本金 | 540 天 |
