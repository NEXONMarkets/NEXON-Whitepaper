...
* **已结算 ≠ 已交付。** 钱到了商户账上，房间不一定订上了。

用户可以批准一笔 EXON 现货操作，而完全没有批准酒店订单；数字支付可能成功，商户仍未履约。把这三件事分开记，是这套结构最实际的一处收益。
...
因为责任无法被界面吸收。一个 App 可以把四个系统的界面合成一个，但它合并不了四份法律义务。当酒店没入住成功时，能解决问题的仍然是酒店；当链上转账不可逆时，没有任何界面能把它撤回。
