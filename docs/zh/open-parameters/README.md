...
2026 年 9 月 10 日定稿的现行机制关掉了经济层面的主要问题：双币角色、入金拆分与燃料、每 12 小时 0.2% – 0.6% 的结算、期限加成、期满取回与自动续期、三档到账与销毁、私募三档与 3:1 配置、1,095 天释放、20 代推广奖励与 V1 – V12 领导奖金。9 月 8 日的叙事补充关掉了品牌含义、双币叙事与五产品方向。
...
| OP-T03 | 单次产出区间的阶段性调整 | 0.2% – 0.6% 为现行区间，调整按参数版本生效 |
